          ...
          <div className="relative flex justify-center lg:justify-end">
            ...
            <div className="relative w-72 h-72 md:w-80 md:h-80 lg:w-[380px] lg:h-[380px]">
              ...
              <div className="absolute -bottom-5 -left-6 md:-left-10 bg-white rounded-2xl px-5 py-4 shadow-xl flex items-center gap-3 border-l-4 border-l-[#ff6b35]">
                ...
                <div>
                  <p className="font-body font-semibold text-sm text-gray-900">TEDx Speaker</p>
                  <p className="font-body text-xs text-gray-400">Gurgaon, 2026</p>
                </div>
              </div>

              {/* Floating – PhD */}
              <div className="absolute top-1/2 -right-2 md:-right-6 bg-[#0a7c6e] rounded-2xl px-4 py-3 shadow-lg">
                <p className="font-body text-xs font-bold text-white/60 uppercase tracking-wider">Currently</p>
                <p className="font-body text-sm font-semibold text-white mt-0.5">PhD Scholar</p>
              </div>
            </div>
          </div>
        </div>
